...
# Setup prompt
#
RUN echo 'export PS1="[Dynamic API Specification] \$ "' >> ~/.bashrc
RUN echo 'export PROMPT="[Dynamic API Specification] \$ "' >> ~/.zshrc
...
line REST client for $(tput setaf 6)Dynamic API Specification$(tput sgr0).\n\
\n\
